...
#if defined(TEST_GMP_CRASH_DURING_ASYNC_SHUTDOWN) && !defined(TEST_GMP_ASYNC_SHUTDOWN)
#error TEST_GMP_CRASH_DURING_ASYNC_SHUTDOWN requires TEST_GMP_ASYNC_SHUTDOWN
#endif
